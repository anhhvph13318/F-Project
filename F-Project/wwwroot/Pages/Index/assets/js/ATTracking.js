var AT = {
    ...
    track: function() {
        ...
        if (this.is_lastclick) {
            ...
            // Patch 23/12/2025
            // Sai cặp: có utm_source nhưng KHÔNG phải accesstrade và KHÔNG có aff_sid mới -> bỏ qua hoàn toàn, tránh utm khác (fb/google) xoá affiliate hiện tại, không cập nhật cookie
            if (a && b && b !== this.aff_utm_source) return;
            ...
            if (b === this.aff_utm_source || this.aff_utm_sources.indexOf(b) !== -1) {
                ...
                // Patch 23/12/2025
                if (b && !a) {
                    // utm khác nhưng KHÔNG có aff_sid mới -> bỏ qua
                    return;
                }
                
                // Code xóa aff_sid -> nguy hiểm
                if (b) {
                    // xoa cookie
                ...
                // nếu b == null / undefined / ""  → KHÔNG LÀM GÌ CẢ
            }
        } else {
