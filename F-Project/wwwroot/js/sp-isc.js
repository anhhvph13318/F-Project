...
!function () {
    function e(e, n) {
        var t, o = {};
        for (t in e)
            Object.prototype.hasOwnProperty.call(e, t) && 0 > n.indexOf(t) && (o[t] = e[t]);
            ...
            return function (u) {
                return function (t) {
                    ...
                    for (; c && (c = 0,
                        ...
                        try {
                            if (o = 1,
                                r && (i = 2 & t[0] ? r.return : t[0] ? r.throw || ((i = r.return) && i.call(r),
                                    0) : r.next) && !(i = i.call(r, t[1])).done)
                                return i;
                            switch (r = 0,
                            i && (t = [2 & t[0], i.value]),
                            t[0]) {
                                ...
                                default:
                                    if (!(i = a.trys,
                                        (i = 0 < i.length && i[i.length - 1]) || 6 !== t[0] && 2 !== t[0])) {
                                        a = 0;
                                        continue
                                    }
    ...
    function o(e, n, t) {
        if (t || 2 === arguments.length)
            for (var o, r = 0, i = n.length; r < i; r++)
                !o && r in n || (o || (o = Array.prototype.slice.call(n, 0, r)),
                    o[r] = n[r]);
        return e.concat(o || Array.prototype.slice.call(n))
    }
    function r() {
        if (!dn && !(dn = "undefined" != typeof crypto && crypto.getRandomValues && crypto.getRandomValues.bind(crypto)))
            throw Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");
        return dn(pn)
    }
    function i(e, n, t) {
        if (vn.randomUUID && !n && !e)
            return vn.randomUUID();
        if ((e = (e = e || {}).random || (e.rng || r)())[6] = 15 & e[6] | 64,
            e[8] = 63 & e[8] | 128,
            n) {
            t = t || 0;
            for (var o = 0; 16 > o; ++o)
        ...
        return function (e, n = 0) {
            return (sn[e[n + 0]] + sn[e[n + 1]] + sn[e[n + 2]] + sn[e[n + 3]] + "-" + sn[e[n + 4]] + sn[e[n + 5]] + "-" + sn[e[n + 6]] + sn[e[n + 7]] + "-" + sn[e[n + 8]] + sn[e[n + 9]] + "-" + sn[e[n + 10]] + sn[e[n + 11]] + sn[e[n + 12]] + sn[e[n + 13]] + sn[e[n + 14]] + sn[e[n + 15]]).toLowerCase()
        }(e)
    }
    function a() {
        var e, n = {}, t = [], o = [], r = [], i = function (e, t) {
            null != t && "" !== t && (n[e] = t)
        };
        return {
            add: i,
    ...
    function c(e) {
        return function (n, t, r) {
            for (var i = function (t, o, r) {
                        ...
                        if (t) {
                            ...
                            do {
                                ...
                                u = d >> 18 & 63,
                                    ...
                                    l = d >> 6 & 63,
                                    d &= 63,
                                    c[a++] = gn.charAt(u) + gn.charAt(s) + gn.charAt(l) + gn.charAt(d)
                            } while (i < t.length);
                            i = c.join(""),
                                t = ((t = t.length % 3) ? i.slice(0, t - 3) : i) + "===".slice(t || 3)
                        }
                                ...
                                r = function (e) {
                                    ...
                                    do {
                                        ...
                                        a = s >> 16 & 255,
                                            c = s >> 8 & 255,
                                            s &= 255,
                                            i[o++] = 64 === r ? String.fromCharCode(a) : 64 === u ? String.fromCharCode(a, c) : String.fromCharCode(a, c, s)
                                    } while (t < e.length);
                                    return r = i.join(""),
                                        n = r.replace(/\0+$/, ""),
                                        decodeURIComponent(n.split("").map((function (e) {
                ...
                return t ? t.data = t.data.concat(o.data) : t = o,
                    t
            }, c = void 0, u = 0; u < t.length; u++) {
                var s = t[u];
                "cx" === s.keyIfEncoded ? c = a(c, s.json) : i(s.json, s.keyIfEncoded, s.keyIfNotEncoded)
            }
            t.length = 0,
                r.length && (c = a(c, t = {
        ...
        return {
            ...
            addGlobalContexts: function (r) {
                if (Array.isArray(r)) {
                    ...
                    for (i = 0,
                        r = Object.entries(r); i < r.length; i++)
                        a = (u = r[i])[0],
            ...
            removeGlobalContexts: function (r) {
                for (var i = function (r) {
                    "string" == typeof r ? (delete o[r],
                        delete t[r]) : T(r) ? n = n.filter((function (e) {
                            return !x(r, e)
                        }
                        )) : w(r) && (e = e.filter((function (e) {
                            return !x(r, e)
                        }
                        )))
                }, a = 0; a < r.length; a++)
            ...
            getApplicableContexts: function (r) {
                e: {
                    for (var i = 0, a = r.getJson(); i < a.length; i++) {
                        var c = a[i];
                        if ("ue_px" === c.keyIfEncoded && "object" == typeof c.json.data && "string" == typeof (c = c.json.data.schema)) {
                            i = c;
                            break e
                        }
                    }
                ...
                c = "string" == typeof (a = r.getPayload().e) ? a : "",
                    a = [];
                var u = E(e.concat(Object.values(t)), r, c, i);
                        ...
                        return e = S(e).map((function (e) {
                            e: {
                                if (k(e)) {
                                    ...
                                    )) && o++ : "string" == typeof r && C(r, n) && o++,
                                        r = e.reject,
                                        Array.isArray(r) ? e.reject.some((function (e) {
                                            return C(e, n)
                                        }
                                        )) && t++ : "string" == typeof r && C(r, n) && t++,
                                        0 < o && 0 === t
                                }(e[0], o)) {
                                    e = E(e[1], n, t, o);
                                    break e
    ...
    function m(e) {
        if (null !== (e = /^iglu:((?:(?:[a-zA-Z0-9-_]+|\*).)+(?:[a-zA-Z0-9-_]+|\*))\/([a-zA-Z0-9-_.]+|\*)\/jsonschema\/([1-9][0-9]*|\*)-(0|[1-9][0-9]*|\*)-(0|[1-9][0-9]*|\*)$/.exec(e)) && f(e[1]))
            return e.slice(1, 6)
    }
    function p(e) {
        if (e = m(e)) {
    ...
    function g(e) {
        return v(e) ? e.every((function (e) {
            return p(e)
        }
        )) : "string" == typeof e && p(e)
    }
    function h(e) {
        return !!(u(e) && "schema" in e && "data" in e) && ("string" == typeof e.schema && "object" == typeof e.data)
    }
    function y(e) {
    ...
    function k(e) {
        return !(!Array.isArray(e) || 2 !== e.length) && (Array.isArray(e[1]) ? y(e[0]) && e[1].every(w) : y(e[0]) && w(e[1]))
    }
    function b(e) {
        return !(!Array.isArray(e) || 2 !== e.length) && (!!function (e) {
            ...
            return !1
        }(e[0]) && (Array.isArray(e[1]) ? e[1].every(w) : w(e[1])))
    }
    function T(e) {
        return k(e) || b(e)
    }
    function C(e, n) {
        if (!p(e))
            return !1;
        if (e = m(e),
            n = null !== (n = /^iglu:([a-zA-Z0-9-_.]+)\/([a-zA-Z0-9-_]+)\/jsonschema\/([1-9][0-9]*)-(0|[1-9][0-9]*)-(0|[1-9][0-9]*)$/.exec(n)) ? n.slice(1, 6) : void 0,
            e && n) {
            if (!function (e, n) {
                if (n = n.split("."),
                    e = e.split("."),
    ...
    function P(e, n) {
        return "function" == typeof e ? e === n : JSON.stringify(e) === JSON.stringify(n)
    }
    function x(e, n) {
        if (T(e)) {
            if (!T(n))
            ...
            var t = e[1]
                , o = n[1];
            return !!P(e[0], n[0]) && (Array.isArray(t) ? !(!Array.isArray(o) || t.length !== o.length) && t.reduce((function (e, n, t) {
                return e && P(n, o[t])
            }
            ), !0) : !Array.isArray(o) && P(t, o))
        }
        return !!w(e) && (!!w(n) && P(e, n))
    }
    function O(e) {
        void 0 === e && (e = {});
        var n, t, r, a, u, d, f, m = !0, p = e.base64, v = e.corePlugins, g = null != v ? v : [];
        n = null == p || p,
            t = g,
            r = e.callback,
            a = function (e) {
                ...
                if (m) {
                    if (e.withJsonProcessor(c(d)),
                        ...
                        n = function (e, n) {
                            ...
                            var t = [];
                            return n && n.length && t.push.apply(t, n),
                        ...
                        !t.find((function (n) {
                            try {
                                ...
                                return hn.error("Plugin filter", e),
                                    !1
                            }
                        }
                        ))) {
                    ...
                    hn.error("Track called on deactivated tracker")
            },
        ...
        return null == g || g.forEach((function (e) {
            var n, t;
            null === (n = e.logger) || void 0 === n || n.call(e, hn),
                null === (t = e.activateCorePlugin) || void 0 === t || t.call(e, h)
        }
    ...
    function I(e, n) {
        ...
        var t, o = {};
        for (t in e)
            (n[t] || null !== e[t] && void 0 !== e[t]) && (o[t] = e[t]);
        return o
    }
    function L(e) {
        var n = e.maxSize
        ...
        return {
            ...
            iterator: function () {
                ...
                return {
                    next: function () {
                        return e < n.length ? Promise.resolve({
                            value: n[e++],
                            done: !1
                        }) : Promise.resolve({
                            value: void 0,
            ...
            getAllPayloads: function () {
                return Promise.resolve(r.map((function (e) {
                    return e.payload
                }
                )))
            }
    ...
    function U(e) {
        function n() {
            var e = b.reduce((function (e, n) {
                return e + (T ? n.getPOSTRequestBytesCount() : n.getGETRequestBytesCount())
            }
            ), 0);
            return T && (e += 88),
                e
        ...
        function t() {
            var e = new Headers;
            return T && e.append("Content-Type", "application/json; charset=UTF-8"),
                m && Object.keys(m).forEach((function (n) {
                    e.append(n, m[n])
                }
                )),
                0 < b.length && b[0].getServerAnonymization() && e.append("SP-Anonymous", "*"),
                e
        }
        function o() {
            var e = c;
            return c.includes("://") || (e = "".concat(s, "://").concat(c)),
        ...
        var c = e.endpoint
            ...
            , l = e.port;
        u = e.eventMethod;
        var d, f, m = e.customHeaders, p = e.connectionTimeout, v = e.keepalive, g = void 0 !== v && v, h = void 0 === (v = e.postPath) ? "/com.snowplowanalytics.snowplow/tp2" : v, y = void 0 === (v = e.useStm) || v, w = void 0 === (v = e.maxPostBytes) ? 4e4 : v, k = void 0 === (e = e.credentials) ? "include" : e, b = [], T = "post" === (void 0 === u ? "post" : u).toLowerCase();
        return {
            addEvent: function (e) {
                return !(0 < b.length && (0 < b.length ? b[0].getServerAnonymization() : void 0) !== e.getServerAnonymization()) && (b.push(e),
                    !0)
            },
            getEvents: function () {
                return b
            ...
            toRequest: function () {
                if (0 !== b.length) {
                    ...
                    return r(b[0].getGETRequestURL(o(), y), {
                        method: "GET"
                    })
                }
            },
    ...
    function B(e) {
        for (var n = 0, t = 0; t < e.length; t++) {
            ...
            127 >= o ? n += 1 : 2047 >= o ? n += 2 : 55296 <= o && 57343 >= o ? (n += 4,
                t++) : n = 65535 > o ? n + 3 : n + 4
        }
        return n
    }
    function R(e) {
        ...
        function t(e) {
            if (null === r) {
                ...
                for (n in e)
                    e.hasOwnProperty(n) && !t[n] && o.push(n + "=" + encodeURIComponent(e[n]));
                for (var i in t)
                    e.hasOwnProperty(i) && t[i] && o.push(i + "=" + encodeURIComponent(e[i]));
                r = "?" + o.join("&")
            }
            return r
        }
        ...
        return {
            ...
            getGETRequestURL: function (e, o) {
                var r = t(n());
                return o ? e + r.replace("?", "?stm=" + (new Date).getTime() + "&") : e + r
            },
            ...
            getPOSTRequestBytesCount: function () {
                return null === c && (c = B(JSON.stringify(o()))),
                    c
            }
        }
    }
    function D(e) {
        ...
        function r(e) {
            return n(this, void 0, void 0, (function () {
                ...
                return t(this, (function (t) {
                    switch (t.label) {
                        case 0:
                            if (void 0 === (n = e.toRequest()))
                                throw Error("Empty batch");
                            ...
                            return t.sent(),
                                ...
                                i.ok ? (function (e, n) {
                                    ...
                                    [2, {
                                        ...
                                        return !(200 <= e && 300 > e || !E || !S.includes(e) && _.includes(e))
                                    }(i.status),
                                        o({
                                            events: r,
                                            status: i.status,
                        ...
                        case 4:
                            return c = t.sent(),
                                e.closeRequest(!1),
                                u = "string" == typeof c ? c : c ? c.message : "Unknown error",
                                o({
                                    events: r,
                                    message: u,
                                    willRetry: !0
            ...
            return n(this, void 0, void 0, (function () {
                ...
                return t(this, (function (n) {
                    switch (n.label) {
                        ...
                        case 3:
                            return e = n.sent(),
                                hn.error("Error sending events", e),
                                [3, 5];
                        case 4:
                            return D = !1,
                                [7];
                ...
                return t(this, (function (t) {
                    switch (t.label) {
                        ...
                        case 3:
                            return o = t.sent(),
                                c = o.value,
                                o.done || void 0 === c ? [3, 4] : (s = R(c),
                                    e.addEvent(s) ? [3, 2] : [3, 4]);
                        case 4:
                        ...
                        case 5:
                            return l = t.sent(),
                                ...
                                f = l.retry,
                                m = l.status,
                                !d && f ? [3, 7] : (d || hn.error("Status ".concat(m, ", will not retry.")),
                                    [4, j.removeHead(e.countEvents())]);
                        case 6:
                            t.sent(),
                                t.label = 7;
                        case 7:
        ...
        var s = e.endpoint
            ...
            , b = e.keepalive
            , T = e.cookieExtensionService;
        l = e.idService;
        var C = e.dontRetryStatusCodes
            , _ = void 0 === C ? [] : C
            , S = void 0 === (C = e.retryStatusCodes) ? [] : C
            , E = void 0 === (C = e.retryFailedRequests) || C
            , P = e.onRequestFailure
            , x = e.onRequestSuccess
            , O = void 0 === (C = e.customFetch) ? fetch : C
            , A = e.useStm
            , j = void 0 === (C = e.eventStore) ? L({}) : C
            , I = e.credentials;
        T = T || l;
        var B = !1
            , D = !1
            , N = "post" === d.toLowerCase();
        return _ = _.concat([400, 401, 403, 410, 422]),
        {
            flush: c,
            input: function (e) {
                return n(this, void 0, void 0, (function () {
                            ...
                            case 0:
                                e: {
                                    if (t = o = R(n = {
                                        ...
                                        (u = (t = t.getGETRequestBytesCount()) > g) && hn.warn("Event (" + t + "B) too big, max is " + g)
                                    }
                                    t = u
                                }
                                return t ? ((a = i()).addEvent(o),
                                    [4, r(a)]) : [3, 2];
                            case 1:
                                return t.sent(),
                                    [3, 5];
    ...
    function G(e) {
        ...
        return n || (e = e.text || "",
            (n = document.getElementsByTagName("title")) && null != n[0] && (e = n[0].text)),
            e
    }
    function q(e) {
    ...
    function W(e, n, t, o) {
        return e.addEventListener ? (e.addEventListener(n, t, o),
    ...
    function te(e, n) {
        var t, o = null !== (t = e.eventStore) && void 0 !== t ? t : function (e) {
            function n() {
    ...
    function oe(e, n, t) {
        return "translate.googleusercontent.com" === e ? ("" === t && (t = n),
            e = q(n = null != (e = (e = /^(?:https?|ftp)(?::\/*(?:[^?]+))([?][^#]+)/.exec(n)) && 1 < (null == e ? void 0 : e.length) ? Z("u", e[1]) : null) ? e : "")) : "cc.bingj.com" !== e && "webcache.googleusercontent.com" !== e || (e = q(n = document.links[0].href)),
            [e, n, t]
    }
    function re(e, n) {
        return void 0 === n && (n = {
    ...
    function ce() {
        return "ResizeObserver" in window ? (Tn || (Tn = ue()),
            function () {
                if (!En && document && document.body && document.documentElement) {
                    En = !0;
                    var e = new ResizeObserver((function () {
                        Pn || (Pn = requestAnimationFrame((function () {
                            Pn = null,
                                Tn = ue()
                        }
                        )))
    ...
    function ue() {
        ...
        if ("innerWidth" in window)
            ...
            n = (t = document.documentElement || document.body).clientWidth,
                t = t.clientHeight;
        e = e(Math.max(0, n) + xn + Math.max(0, t)),
            n = se;
        var o = document.documentElement
            , r = document.body;
        return t = Math.max(o.clientWidth, o.offsetWidth, o.scrollWidth),
            o = Math.max(o.clientHeight, o.offsetHeight, o.scrollHeight, r ? Math.max(r.offsetHeight, r.scrollHeight) : 0),
        {
            viewport: e,
            documentSize: n(t = isNaN(t) || isNaN(o) ? "" : t + xn + o),
            resolution: se(screen.width + xn + screen.height),
    ...
    function se(e) {
        return e && e.split(xn).map((function (e) {
    ...
    function le(e, n, t, r, c, u) {
        ...
        e = function (e, n, t, r, c, u) {
            function l() {
                (We = oe(window.location.hostname, window.location.href, J()))[1] !== Xe && (Qe = J(Xe)),
                    Ze = H(We[0]),
                    Xe = We[1]
            }
            function d(e) {
                return function (n) {
                    ...
                    if (n = function (e, n, t) {
                        ...
                        var i = t.domainUserId
                            ...
                            , l = t.event
                            , d = l.currentTarget;
                        return l = "function" == typeof n.reason ? n.reason(l) : null === (o = null == d ? void 0 : d.textContent) || void 0 === o ? void 0 : o.trim(),
                            e ? [i, r, n.sessionId && c, n.userId && F(a || ""), n.sourceId && F(u || ""), n.sourcePlatform && s, n.reason && F(l || "")].map((function (e) {
                                return e || ""
                            }
            ...
            function f(e) {
                for (var n = d(Bn), t = 0; t < document.links.length; t++) {
                    ...
                    !o.spDecorationEnabled && e(o) && (o.addEventListener("click", n, !0),
            ...
            function C(e, n, t) {
                ...
                return ("cookie" == wn || "cookieAndLocalStorage" == wn) && Pe.setCookie(e, n, t, cn, rn, sn, ln)
            }
            function _(e) {
                var n = on + "id." + Ve
                    , t = on + "ses." + Ve;
                N(n),
                    ...
                    null != e && e.preserveSession || (Me = i(),
                        bn = 1),
                    null != e && e.preserveUser || (Fe = yn ? "" : i(),
                        ze = null)
            }
            function S(e) {
                e && e.stateStorageStrategy && (u.stateStorageStrategy = e.stateStorageStrategy,
                    wn = Te(u)),
                    yn = !!u.anonymousTracking,
                    vn = Ce(u),
                    gn = _e(u),
                    Tn.setUseLocalStorage("localStorage" == wn || "cookieAndLocalStorage" == wn),
            ...
            function P() {
                return "none" == wn ? ["1", "", 0, 0, 0, void 0, "", "", "", void 0, 0] : function (e, n, t, o) {
                    ...
                    return n = function (e) {
                        ...
                        ,
                        [e[0], e[1], a(e[2], r), a(e[3], o), a(e[4], r), n(e[5]), e[6], e[7], e[8], n(e[9]), a(e[10], 0)]
            ...
            function A() {
                Cn && null != c.pageViewId || (c.pageViewId = i(),
                    c.pageViewUrl = Oe || Xe)
            }
            function j() {
                return function () {
                    if (null == c.pageViewId)
                        return !0;
                    if (Cn || !En)
                        return !1;
                    if (void 0 === c.pageViewUrl)
                        return !0;
                    var e = Oe || Xe;
                    if (!0 === En || "full" == En || !("URL" in window))
                        return c.pageViewUrl != e;
                    e = new URL(e);
                    var n = new URL(c.pageViewUrl);
                    return "pathname" == En ? e.pathname != n.pathname : "pathnameAndSearch" == En && (e.pathname != n.pathname || e.search != n.search)
                }() && (c.pageViewId = i(),
                    c.pageViewUrl = Oe || Xe),
                    c.pageViewId
            }
            ...
            function L(e) {
                ...
                if (e = e.contextCallback,
                    ...
                    Object.prototype.hasOwnProperty.call(r, "hasSupport") ? W(document, i, h, {
                        passive: !0
                    }) : W(document, i, h),
                        k(),
                        i = function (e, n) {
                ...
                if (xn.enabled && (tn || n))
                    for (o in Ue = o.getTime(),
                        o = void 0,
                        xn.configurations)
                        (n = xn.configurations[o]) && (window.clearInterval(n.activityInterval),
                            U(n, t, e))
            }
            function U(e, n, t) {
                var o = function (e, n) {
                    ...
                    , r = function () {
                        Ue + e.configHeartBeatTimer > (new Date).getTime() && o(e.callback, (n || []).concat(t ? t() : []))
                    };
                e.activityInterval = 0 === e.configMinimumVisitLength ? window.setInterval(r, e.configHeartBeatTimer) : window.setTimeout((function () {
                    Ue + e.configMinimumVisitLength > (new Date).getTime() && o(e.callback, (n || []).concat(t ? t() : [])),
            ...
            function B(e) {
                ...
                hn.error("Activity tracking minimumVisitLength & heartbeatDelay must be integers")
            }
            function R(e) {
                var n = e.context
                    , t = e.minXOffset
            ...
            function D(e) {
                ...
                0 === (null == n ? void 0 : n.configMinimumVisitLength) ? window.clearTimeout(null == n ? void 0 : n.activityInterval) : window.clearInterval(null == n ? void 0 : n.activityInterval),
                    xn.configurations[e] = void 0
            }
            var z, Y, K, $, ee, ne, ue, se, le, de, fe, me, pe, ve, ge, he, ye, we, ke, be;
            ...
            var Te = function (e) {
                ...
                , Ce = function (e) {
                    var n;
                    return "boolean" != typeof e.anonymousTracking && !0 === (null === (n = e.anonymousTracking) || void 0 === n ? void 0 : n.withSessionTracking)
                }
                , _e = function (e) {
                    var n;
                    return "boolean" != typeof e.anonymousTracking && !0 === (null === (n = e.anonymousTracking) || void 0 === n ? void 0 : n.withServerAnonymisation)
                }
                , Se = null !== (K = null === (Y = null == u ? void 0 : u.contexts) || void 0 === Y ? void 0 : Y.browser) && void 0 !== K && K
                , Ee = null === (ee = null === ($ = null == u ? void 0 : u.contexts) || void 0 === $ ? void 0 : $.webPage) || void 0 === ee || ee
                , Pe = u.synchronousCookieWrite ? An : On;
            s.push({
                beforeTrack: function (e) {
                    var n = v("ses")
                        , t = P()
                        , o = 0 === t[10];
                    if (Ge = !!Le && !!Pe.getCookie(Le),
                        fn || Ge)
                        _();
                    else {
                        if ("0" === t[0] ? (Me = n || "none" == wn ? t[6] : re(t),
                            bn = t[3]) : (new Date).getTime() - kn > 1e3 * pn && (bn++,
                                Me = re(t, {
                                    memorizedVisitCount: bn
                                })),
                            ie(t),
                            0 === t[10]) {
                            var r = e.build();
            ...
            var xe, Oe, Ae, je, Ie, Le, Ue, Be, Re, De, Ne, Ve, Fe, Me, ze, Ge, qe, He = O({
                base64: null !== (ue = u.encodeBase64) && void 0 !== ue ? ue : "post" !== u.eventMethod,
                corePlugins: s,
                callback: function (e) {
                    fn || Ge || Tn.enqueueRequest(e.build())
                }
            }), Je = document.characterSet || document.charset, We = oe(window.location.hostname, window.location.href, J()), Ze = H(We[0]), Xe = We[1], Qe = We[2], Ye = null !== (se = u.platform) && void 0 !== se ? se : "web", Ke = null !== (le = u.appId) && void 0 !== le ? le : "", $e = u.appVersion, en = document.title, nn = !1, tn = null === (de = u.resetActivityTrackingOnPageView) || void 0 === de || de, on = null !== (fe = u.cookieName) && void 0 !== fe ? fe : "_sp_", rn = null !== (me = u.cookieDomain) && void 0 !== me ? me : void 0, an = null !== (pe = u.discoverRootDomain) && void 0 !== pe ? pe : void 0 === rn, cn = "/", sn = null !== (ve = u.cookieSameSite) && void 0 !== ve ? ve : "Lax", ln = null === (ge = u.cookieSecure) || void 0 === ge || ge, dn = window.navigator.doNotTrack || window.navigator.msDoNotTrack || window.doNotTrack, fn = void 0 !== u.respectDoNotTrack && (u.respectDoNotTrack && ("yes" === dn || "1" === dn)), mn = null !== (he = u.cookieLifetime) && void 0 !== he ? he : 63072e3, pn = null !== (ye = u.sessionCookieTimeout) && void 0 !== ye ? ye : 1800, vn = Ce(u), gn = _e(u), yn = !!u.anonymousTracking, wn = Te(u), kn = (new Date).getTime(), bn = 1, Tn = te(un({
                trackerId: e,
                endpoint: x(r),
                serverAnonymization: gn,
                useLocalStorage: "localStorage" == wn || "cookieAndLocalStorage" == wn
            }, u), c), Cn = !1, En = null !== (we = u.preservePageViewIdForUrl) && void 0 !== we && we, Pn = void 0, xn = {
                enabled: !1,
                installed: !1,
                configurations: {}
            }, jn = null !== (be = null === (ke = u.contexts) || void 0 === ke ? void 0 : ke.session) && void 0 !== be && be, In = u.onSessionUpdateCallback, Ln = !1, Un = "boolean" == typeof (qe = u.useExtendedCrossDomainLinker || !1) ? {
                useExtendedCrossDomainLinker: qe
            } : {
                useExtendedCrossDomainLinker: !0,
                collectCrossDomainAttributes: qe
            }, Bn = Un.useExtendedCrossDomainLinker, Rn = Un.collectCrossDomainAttributes;
            an && !rn && (rn = function (e, n) {
            ...
            var Dn = ce()
                ...
                , zn = "object" == typeof Intl && "function" == typeof Intl.DateTimeFormat ? (new Intl.DateTimeFormat).resolvedOptions().timeZone : void 0;
            return He.setTrackerVersion(t),
                ...
                un(un({}, {
                    ...
                    setCustomUrl: function (e) {
                        l();
                        var n, t = Xe;
                        p(e) ? Oe = e : "/" === e.slice(0, 1) ? Oe = p(t) + "://" + q(t) + e : (0 <= (n = (t = m(t)).indexOf("?")) && (t = t.slice(0, n)),
                    ...
                    enableActivityTracking: function (e) {
                        xn.configurations.pagePing || (xn.enabled = !0,
                            xn.configurations.pagePing = B(un(un({}, e), {
                                callback: R
                            })))
                    },
                    enableActivityTrackingCallback: function (e) {
                        xn.configurations.callback || (xn.enabled = !0,
                            xn.configurations.callback = B(e))
                    },
                    ...
                    disableAnonymousTracking: function (e) {
                        var n = (null == e ? void 0 : e.stateStorageStrategy) && e.stateStorageStrategy !== wn && (!yn || vn) && v("ses");
                        u.anonymousTracking = !1,
                            S(e),
                            n && b(),
                            E(),
                            Tn.executeQueue()
                    ...
                    enableAnonymousTracking: function (e) {
                        var n;
                        u.anonymousTracking = null === (n = e && (null == e ? void 0 : e.options)) || void 0 === n || n,
                            S(e),
                            vn || A()
                    },
                    clearUserData: _
        ...
        var l = un(un({}, e), {
            addPlugin: function (e) {
                var n, t;
                l.core.addPlugin(e),
                    null === (t = (n = e.plugin).activateBrowserPlugin) || void 0 === t || t.call(n, l)
            }
        });
    ...
    function de(e, n) {
        try {
            pe(null != e ? e : Object.keys(jn), jn).forEach(n)
        } catch (e) {
    ...
    function me(e, n, t, o, r, i) {
        return jn.hasOwnProperty(e) ? null : (jn[e] = le(e, n, t, o, r, i),
            jn[e])
    }
    function pe(e, n) {
    ...
    function ve() {
        ...
        var n = new In
            , t = document
            , o = window;
        return t.visibilityState && W(t, "visibilitychange", (function () {
            ...
            "loading" === document.readyState ? (t.addEventListener ? t.addEventListener("DOMContentLoaded", (function n() {
                t.removeEventListener("DOMContentLoaded", n, !1),
                    e()
            }
            )) : t.attachEvent && t.attachEvent("onreadystatechange", (function n() {
                "complete" === t.readyState && (t.detachEvent("onreadystatechange", n),
                    e())
            }
            )),
                W(o, "load", e, !1)) : e(),
    ...
    function ge(e) {
        return void 0 === e && (e = Bn),
        {
            contexts: function () {
                ...
                return r && ((t = Array.isArray(a) ? o([], a, !0) : [a]).unshift(""),
                    t.forEach((function (e) {
                        var t = Q(e + "_ga")
                            , r = [];
                        i && (Array.isArray(i) ? o([], i, !0) : [i]).forEach((function (n) {
    ...
    function ye(e) {
        void 0 === e && (e = Object.keys(Fn)),
            e.forEach((function (e) {
                Fn[e] && Mn[e] && (window.removeEventListener("click", Mn[e], !0),
                    window.removeEventListener("mouseup", Mn[e], !0),
                    window.removeEventListener("mousedown", Mn[e], !0))
            }
            ))
    }
    function we(e, n) {
        void 0 === n && (n = Object.keys(Fn)),
            fe(n, Fn, (function (n) {
                var t, o, r;
                if ("element" in e) {
                    var i = null !== (r = null !== (t = e.trackContent) && void 0 !== t ? t : null === (o = zn[n.id]) || void 0 === o ? void 0 : o.linkTrackingContent) && void 0 !== r && r;
                    t = function (e, n) {
                        void 0 === n && (n = !1);
                        ...
                        if (!Vn.test(o)) {
                            ...
                            var r = $(e)
                                , i = e.target;
                            return n = n ? e.innerHTML : void 0,
                                o || null == Gn || Gn.warn("Link click target URL empty", e),
                                j({
    ...
    function ke(e, n) {
        var t = zn[e].linkTrackingContext
            , o = zn[e].linkTrackingFilter
        ...
        !i || null == i.href || o && !o(i) || ("click" === n.type ? we({
            element: i,
            context: d(t, i)
        }, [e]) : "mousedown" === n.type ? 1 === r || 2 === r ? (zn[e].lastButton = r,
            zn[e].lastTarget = i) : delete zn[e].lastButton : "mouseup" === n.type && (r === zn[e].lastButton && i === zn[e].lastTarget && we({
                element: i,
                context: d(t, i)
            }, [e]),
                delete zn[e].lastButton,
                delete zn[e].lastTarget))
    }
    function be(e, n) {
        var t, o = n.options;
        n = n.context;
        var r = function (e) {
            if (e) {
                ...
                }(e.forms) ? n = Y(e.forms) : t = e.forms,
                {
                    forms: t,
                    formFilter: n,
                    fieldFilter: K(e.fields),
                    fieldTransform: Ee(e.fields)
                }
            }
            return {
                forms: null,
            ...
            , i = null !== (t = null == o ? void 0 : o.events) && void 0 !== t ? t : Jn;
        t = Yn[e.id] = function (e, n) {
            ...
            -1 !== i.indexOf(Cn.FOCUS_FORM) && (Zn[e.id] = xe(e, r, Cn.FOCUS_FORM, n),
                t.forEach((function (n) {
                    return W(n, "focus", Zn[e.id], !0)
                }
                ))),
            -1 !== i.indexOf(Cn.CHANGE_FORM) && (Xn[e.id] = xe(e, r, Cn.CHANGE_FORM, n),
                t.forEach((function (n) {
                    return W(n, "change", Xn[e.id], !0)
                }
                ))),
            -1 !== i.indexOf(Cn.SUBMIT_FORM) && (Qn[e.id] = function (e, n, t) {
                return function (o) {
                    var r;
                    if (Ce(o = o.target, "FORM") && n.formFilter(o) && Se(o, n.forms)) {
                        var i = [];
                        (function (e) {
                            var n = [];
                            return Array.prototype.forEach.call(e.elements, (function (e) {
                                if (_e(e)) {
                                    ...
                                    if ("submit" !== t && "image" !== t) {
                                        ...
                                        Ce(e, "INPUT") && (o.elementData.type = t,
                                            "password" !== t && ("checkbox" !== t && "radio" !== t || e.checked) || (o.elementData.value = null)),
                                            n.push(o)
                                    }
                                }
                            }
                            ...
                            var t = e.elementData;
                            e = e.originalElement,
                                n.fieldFilter(e) && "password" !== e.type.toLowerCase() && (t.value = n.fieldTransform(t.value, t, e),
                                    i.push(t))
                        }
                        )),
                ...
                t.forEach((function (n) {
                    return W(n, "submit", Qn[e.id], !0)
                }
                )))
    }
    function Te(e) {
        var n;
        (null !== (n = Yn[e.id]) && void 0 !== n ? n : [document]).forEach((function (n) {
            Zn[e.id] && n.removeEventListener("focus", Zn[e.id], !0),
                Xn[e.id] && n.removeEventListener("change", Xn[e.id], !0),
                Qn[e.id] && n.removeEventListener("submit", Qn[e.id], !0)
        }
        ))
    }
    function Ce(e, n) {
        return !("object" != typeof e || !e || !("tagName" in e) || "string" != typeof e.tagName) && e.tagName.toUpperCase() === n
    }
    function _e(e) {
    ...
    function Ee(e) {
        return e && "function" == typeof e.transform ? e.transform : Wn
    }
    function Pe(e) {
        for (var n = 0, t = ["name", "id", "type", "nodeName"]; n < t.length; n++) {
            var o = t[n];
            if (e[o] && "string" == typeof e[o])
                return e[o]
        }
        return null
    }
    function xe(e, n, t, o) {
        return function (r) {
            var i, a, c = r.composed ? r.composedPath()[0] : r.target;
            if (c !== r.target && r.composed && _e(c) && (c.form ? (Xn[e.id] && W(c.form, "change", Xn[e.id], !0),
                Qn[e.id] && W(c.form, "submit", Qn[e.id], !0)) : Xn[e.id] && W(c, "change", Xn[e.id], !0)),
                _e(c) && n.fieldFilter(c)) {
                var u = null;
                Ce(c, "INPUT") ? r = "checkbox" === (u = (c.type || "text").toLowerCase()) && !c.checked || "password" === u ? null : n.fieldTransform(c.value, c, c) : r = n.fieldTransform(c.value, c, c);
                e: if (c && c.form)
                    var s = c.form;
                else {
                    for (var l = c; l;) {
                ...
                if (s && n.formFilter(s) && Se(s, n.forms) && ("change_form" === t || "checkbox" !== u && "radio" !== u)) {
                    ...
                    s = {
                        ...
                        "change_form" === t ? (m = "iglu:com.snowplowanalytics.snowplow/change_form/jsonschema/1-0-0",
                            s.type = a) : "focus_form" === t && (m = "iglu:com.snowplowanalytics.snowplow/focus_form/jsonschema/1-0-0",
                                s.elementType = a),
                        s = A({
                            event: {
                                schema: m,
    ...
    function Ae(e, n) {
        return void 0 === n && (n = 8192),
            e && e.length > n ? e.substring(0, n) : e
    }
    function je() {
        return {
            activateBrowserPlugin: function (e) {
            ...
            e.core.track(A({
                event: {
                    ...
                    data: {
                        ...
                        message: null != l ? l : "trackError called without required message",
                        stackTrace: s,
                        lineNumber: r,
                        lineColumn: i,
                        fileName: o
    ...
    function Xe(e, n) {
        ...
        return e.items.map((function (e) {
            var t = [e.item_category, e.item_category2, e.item_category3, e.item_category4, e.item_category5].filter(Boolean).join(o);
            return {
                currency: n,
                id: e.item_id,
                name: e.item_name,
    ...
    function tn(e) {
        void 0 === e && (e = Object.keys(dt)),
            e.forEach((function (e) {
                ft[e] && document.removeEventListener("click", ft[e], !0)
            }
            ))
    }
    function on(e) {
        return [{
            ...
            data: "entryType duration nextHopProtocol workerStart redirectStart redirectEnd fetchStart domainLookupStart domainLookupEnd connectStart secureConnectionStart connectEnd requestStart responseStart responseEnd transferSize encodedBodySize decodedBodySize serverTiming unloadEventStart unloadEventEnd domInteractive domContentLoadedEventStart domContentLoadedEventEnd domComplete loadEventStart loadEventEnd type redirectCount activationStart deliveryType".split(" ").reduce((function (n, t) {
                var o = e[t];
                return "serverTiming" === t && Array.isArray(o) ? n[t] = o.length ? o.map((function (e) {
                    return {
    ...
    function rn() {
        return {
            activateBrowserPlugin: function () {
                "undefined" != typeof PerformanceObserver && new PerformanceObserver((function (e) {
                    0 < (e = e.getEntries()[0]).loadEventEnd && (Hn = on(e))
                }
                )).observe({
                    type: "navigation",
                    buffered: !0
            ...
            contexts: function () {
                var e;
                return (e = Hn) || (e = (e = window.performance || window.mozPerformance || window.msPerformance || window.webkitPerformance || {}).getEntriesByType && (e = e.getEntriesByType("navigation")[0]) ? on(e) : []),
                    e
            }
        }
    }
    function an(e) {
        function n(n) {
            return function (t) {
                e[n] = t.value,
                    e.navigationType = t.navigationType
            }
        }
        var t, o, r, i, a, c, u = window.webVitals;
        u ? (null === (t = u.onCLS) || void 0 === t || t.call(u, n("cls")),
            null === (o = u.onFID) || void 0 === o || o.call(u, n("fid")),
            null === (r = u.onLCP) || void 0 === r || r.call(u, n("lcp")),
            null === (i = u.onFCP) || void 0 === i || i.call(u, n("fcp")),
            null === (a = u.onINP) || void 0 === a || a.call(u, n("inp")),
            null === (c = u.onTTFB) || void 0 === c || c.call(u, n("ttfb"))) : hn.warn("The window.webVitals API is currently unavailable. web_vitals events will not be collected.")
    }
    function cn(e) {
        void 0 === e && (e = ht);
        var n, t, o = {}, r = un(un({}, ht), e);
        return {
            activateBrowserPlugin: function (e) {
                n = e.id,
                    vt[n] = e,
                    r.loadWebVitalsScript && (t = function (e) {
                        var n = document.createElement("script");
                        return n.setAttribute("src", e),
                    ...
                    gt || (t ? t.addEventListener("load", (function () {
                        return an(o)
                    }
                    )) : an(o),
                        function (e) {
                            if (-1 !== (PerformanceObserver && PerformanceObserver.supportedEntryTypes || []).indexOf("layout-shift")) {
                                var n = function () {
                            ...
                            Object.keys(o).length && fe(Object.keys(vt), vt, (function (e) {
                                var n;
                                e.core.track(A({
                                    event: {
    ...
    var dn, fn, mn, pn = new Uint8Array(16), vn = {
        ...
        return void 0 === e && (e = fn.warn),
        {
            ...
            warn: function (n, t) {
                for (var r = [], i = 2; i < arguments.length; i++)
                    r[i - 2] = arguments[i];
                e >= fn.warn && "undefined" != typeof console && (i = "Snowplow: " + n,
                    t ? console.warn.apply(console, o([i + "\n", t], r, !1)) : console.warn.apply(console, o([i], r, !1)))
            },
            error: function (n, t) {
                for (var r = [], i = 2; i < arguments.length; i++)
                    r[i - 2] = arguments[i];
                e >= fn.error && "undefined" != typeof console && (i = "Snowplow: " + n + "\n",
                    t ? console.error.apply(console, o([i + "\n", t], r, !1)) : console.error.apply(console, o([i], r, !1)))
            },
            debug: function (n) {
                for (var t = [], r = 1; r < arguments.length; r++)
                    t[r - 1] = arguments[r];
                e >= fn.debug && "undefined" != typeof console && console.debug.apply(console, o(["Snowplow: " + n], t, !1))
            },
            info: function (n) {
                for (var t = [], r = 1; r < arguments.length; r++)
                    t[r - 1] = arguments[r];
                e >= fn.info && "undefined" != typeof console && console.info.apply(console, o(["Snowplow: " + n], t, !1))
            }
        }
    }()
        , yn = {}
    ...
    !function () {
        var e = {
            ...
            bytesToWords: function (e) {
                for (var n = [], t = 0, o = 0; t < e.length; t++,
                    o += 8)
                    n[o >>> 5] |= e[t] << 24 - o % 32;
                return n
            },
            ...
            base64ToBytes: function (e) {
                ...
                for (var n = [], t = 0, o = 0; t < e.length; o = ++t % 4)
                    0 != o && n.push(("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(e.charAt(t - 1)) & Math.pow(2, -2 * o + 8) - 1) << 2 * o | "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(e.charAt(t)) >>> 6 - 2 * o);
                return n
            }
        };
        wn = e
        ...
        var e = wn
            ...
            , o = function (o, r) {
                var i = e.wordsToBytes
                    , a = o;
                a.constructor == String ? a = n.stringToBytes(a) : "undefined" != typeof Buffer && "function" == typeof Buffer.isBuffer && Buffer.isBuffer(a) ? a = Array.prototype.slice.call(a, 0) : Array.isArray(a) || (a = a.toString()),
                    o = e.bytesToWords(a);
                var c = 8 * a.length;
                a = [];
                var u = 1732584193
                ...
                for (o[c >> 5] |= 128 << 24 - c % 32,
                    ...
                    for (var m = u, p = s, v = l, g = d, h = f, y = 0; 80 > y; y++) {
                        ...
                        w = (u << 5 | u >>> 27) + f + (a[y] >>> 0) + (20 > y ? 1518500249 + (s & l | ~s & d) : 40 > y ? 1859775393 + (s ^ l ^ d) : 60 > y ? (s & l | s & d | l & d) - 1894007588 : (s ^ l ^ d) - 899497514),
                            f = d,
                            d = l,
                            l = s << 30 | s >>> 2,
                            s = u,
                ...
                return i = i.call(e, [u, s, l, d, f]),
                    r && r.asBytes ? i : r && r.asString ? t.bytesToString(i) : e.bytesToHex(i)
            };
        o._blocksize = 16,
            o._digestsize = 20,
            yn = o
    ...
    var Tn, Cn, _n = yn, Sn = {
        ...
        function e(e) {
            return n[e] || (n[e] = function (e) {
                ...
                return {
                    getValue: function () {
                        var n;
                        return o && (!r || r > new Date) && null !== (n = o[0]) && void 0 !== n ? n : Q(e)
                    },
                    setValue: function (e, a, c, u, s, l) {
                        return o = [e, a, c, u, s, l],
                            i = !1,
                            ...
                            r = new Date(Date.now() + 1e3 * Math.min(.05, null != a ? a : .05)),
                            !0
                    },
    ...
    }, Ln = "undefined" != typeof window ? ve() : void 0, Un = Object.freeze({
        __proto__: null,
        ...
        newTracker: function (e, n, t) {
            if (Ln)
                return me(e, e, "js-".concat("4.6.5"), n, Ln, t)
        },
        ...
        __proto__: null,
        GaCookiesPlugin: ge
    }), Dn = ["a", "area"], Nn = Dn.join(", "), Vn = /^(javascript|vbscript|jscript|mocha|livescript|ecmascript):/i, Fn = {}, Mn = {}, zn = {}, Gn = void 0, qn = Object.freeze({
        __proto__: null,
                ...
                n.forEach((function (n) {
                    if (Fn[n]) {
                        ...
                        zn[n] = {
                            ...
                            Mn[n] = Mn[n] || ke.bind(null, n),
                            zn[n].linkTrackingPseudoClicks ? (W(window, "mouseup", Mn[n], !0),
                                W(window, "mousedown", Mn[n], !0)) : W(window, "click", Mn[n], !0)
                    }
                }
                ))
        },
        refreshLinkClickTracking: function (e) {
            null == Gn || Gn.warn("refreshLinkClickTracking is deprecated in v4 and has no effect")
        },
        trackLinkClick: we
    });
    !function (e) {
    ...
    var Hn, Jn = [Cn.CHANGE_FORM, Cn.FOCUS_FORM, Cn.SUBMIT_FORM], Wn = function (e) {
        return e
    }, Zn = {}, Xn = {}, Qn = {}, Yn = {}, Kn = {}, $n = Object.freeze({
        __proto__: null,
                ...
                if (t && z(t) && t(e) || null == t) {
                    ...
                    o && z(o) && (a = a.concat(o(e))),
                        "message" in e ? Ie({
                            ...
                            error: e.error,
                            context: a
                        }, i) : e.target && "tagName" in e.target ? (e = e.target,
                            Ie({
                                message: "Non-script error on ".concat(e.tagName, " element"),
        ...
        setEcommerceUser: function (e, n) {
            ...
            n.forEach((function (e) {
                ct[e] && (ct[e] = Je(ct[e], "iglu:com.snowplowanalytics.snowplow.ecommerce/user/jsonschema/1-0-0"),
                    ct[e].push({
        ...
        setPageType: function (e, n) {
            ...
            var t = e.type
                ...
                , r = e.locale;
            n.forEach((function (e) {
                ct[e] && (ct[e] = Je(ct[e], "iglu:com.snowplowanalytics.snowplow.ecommerce/page/jsonschema/1-0-0"),
                    ct[e].push({
        ...
        trackEnhancedEcommerceCheckoutStep: function (e, n) {
            De(un({
                step: e.checkout.actionField.step
            }, n))
        },
        ...
        trackGA4AddShippingInfo: function (e, n) {
            De({
                step: n.step,
                delivery_method: e.shipping_tier
            })
        },
        trackGA4AddToCart: function (e, n) {
            var t, o = e.currency || n.currency;
            n = null !== (t = e.finalCartValue) && void 0 !== t ? t : n.finalCartValue,
                Ge({
                    products: e = Xe(e, o),
                    total_value: n,
                    currency: o
        ...
        trackGA4SelectItem: function (e, n) {
            void 0 === n && (n = {}),
                ...
                Ve({
                    name: e.item_list_id || e.item_list_name,
                    product: n
                })
        },
            ...
            void 0 === e && (e = {}),
                ...
                n.forEach((function (n) {
                    ...
                    ft[n] = function (t) {
                        e: {
                            var o = function (e) {
                                ...
                                if ("object" == typeof e) {
                                    if ("allowlist" in e)
                                        return function (n) {
                                            return Array.from((null == n ? void 0 : n.classList) || []).some((function (n) {
                            ...
                            for (t = t.composed ? t.composedPath()[0] : t.target; t;) {
                                if (t instanceof HTMLButtonElement || t instanceof HTMLInputElement && "button" === t.type) {
                                    if (o(t)) {
                                        o = t;
                                        var a = {};
                                        a.label = "INPUT" === o.tagName ? o.dataset.spButtonLabel || o.value : o.dataset.spButtonLabel || o.innerText || ("function" == typeof r ? r(o) : r) || "(empty)",
                                            o.id && (a.id = o.id),
                                            o.name && (a.name = o.name),
                                            o.classList.length && (a.classes = Array.from(o.classList)),
                                            (r = a).context = d(i, r, t),
                                            nn(r, [n])
                                    }
                                    break e
                        ...
                        ;
                    var r = function () {
                        document.addEventListener("click", ft[n], !0)
                    };
                    null !== (t = dt[n]) && void 0 !== t && t.sharedState.hasLoaded ? r() : null === (o = dt[n]) || void 0 === o || o.sharedState.registeredOnLoadHandlers.push(r)
                }
                ))
        },
        trackButtonClick: nn
        ...
        webVitalsSource: "https://unpkg.com/web-vitals@4/dist/web-vitals.iife.js",
        context: []
    }, yt = Object.freeze({
        __proto__: null,
        WebVitalsPlugin: cn
    }), wt = window.GlobalSnowplowNamespace.shift(), kt = window[wt];
    kt.q = function (n, t) {
        function o(e) {
            var n = e.split(":");
        ...
        function r(e, n) {
            if (h[e])
                ...
                hn.warn(e + " is not an available function")
        }
        function i(e) {
            h = un(un({}, h), e)
        }
            ...
            if ("string" != typeof t[0] || "string" != typeof t[1] || void 0 !== t[2] && "object" != typeof t[2])
                ...
                var o = "".concat(n, "_").concat(t[0])
                    ...
                    , a = function (n) {
                        ...
                        var r = [];
                        if (n) {
                            var i = e(Rn, ["GaCookiesPlugin"]);
                            n = "object" == typeof n ? ge(n) : ge(),
                                r.push([n, i])
                        }
                        return i = e(qn, ["LinkClickTrackingPlugin"]),
                            r.push([he(), i]),
                            i = e($n, ["FormTrackingPlugin"]),
                            r.push([Oe(), i]),
                            i = e(nt, ["ErrorTrackingPlugin"]),
                            r.push([je(), i]),
                            i = e(ot, ["AdTrackingPlugin"]),
                            r.push([Le(), i]),
                            i = e(it, ["SiteTrackingPlugin"]),
                            r.push([Ue(), i]),
                            i = e(ut, ["SnowplowEcommercePlugin"]),
                            r.push([Re(), i]),
                            i = e(lt, ["EnhancedConsentPlugin"]),
                            r.push([Ke(), i]),
                            i = e(mt, ["ButtonClickTrackingPlugin"]),
                            r.push([en(), i]),
                            o && (i = e(pt, ["PerformanceNavigationTimingPlugin"]),
                                r.push([rn(), i])),
                            t && (i = e(yt, ["WebVitalsPlugin"]),
                                r.push([cn("object" == typeof t ? t : void 0), i])),
                            r
                    }(r);
                (o = me(o, t[0], "js-".concat(g), t[1], d, un(un({}, r), {
        ...
        function c(n, t) {
            function o(e) {
                Object.prototype.hasOwnProperty.call(m, e) && (s.clearTimeout(m[e].timeout),
                    delete m[e],
                    0 === Object.keys(m).length && p.forEach((function (e) {
                        var n = e[1];
                        void 0 !== h[e[0]] && h[e[0]].length > n.length && Array.isArray(n[0]) && (n = [{}, n[0]]),
                            r(e[0], n)
                    }
                    )))
            }
            var a;
            if ("string" == typeof n[0] && v(n[1]) && (void 0 === n[2] || Array.isArray(n[2]))) {
                var c = n[0]
                    , u = n[1]
                    , d = n[2];
                (null === (a = n[3]) || void 0 === a || a) && (a = s.setTimeout((function () {
                    o(c)
                }
                ), 5e3),
                    m[c] = {
                    ...
                    W(a, "error", (function () {
                        o(c),
                            hn.warn("Failed to load plugin ".concat(u[0], " from ").concat(c))
                    }
                    ), !0),
                    W(a, "load", (function () {
                        var n = u[1]
                        ...
                        if (r && "object" == typeof r) {
                            ...
                            n = e(r, ["symbol" == typeof n ? n : n + ""]),
                                h.addPlugin.apply(null, [{
                                    plugin: a.apply(null, d)
                                }, t]),
                                i(n)
                        }
                        o(c)
        ...
        function u() {
            ...
            for (t = 0; t < e.length; t += 1) {
                ...
                if (z(u))
                    try {
                        for (var s = {}, l = 0, d = pe(f, jn); l < d.length; l++) {
                            var v = d[l];
                            s[v.id.replace("".concat(n, "_"), "")] = v
                        }
                        var g = Array.prototype.slice.call(i)
                            , y = Array.prototype.concat.apply(g, [s]);
                        u.apply(s, y)
                    } catch (e) {
                ...
                u = (s = o(u))[0],
                    s = s[1],
                    "newTracker" === u ? a(i) : (s = s ? s.map((function (e) {
                        return "".concat(n, "_").concat(e)
                    }
                    )) : f,
                        "addPlugin" === u ? c(i, s) : (l = void 0,
                            l = 0 < i.length ? [i[0], s] : void 0 !== h[u] && 2 === h[u].length ? [{}, s] : [s],
                            0 < Object.keys(m).length ? p.push([u, l]) : r(u, l)))
            }
        }
        for (var s = window, l = document, d = ve(), f = [], m = {}, p = [], g = "4.6.5", h = e(Un, ["version"]), y = 0; y < t.length; y++)
            u(t[y]);
        return {
            push: u
        }
